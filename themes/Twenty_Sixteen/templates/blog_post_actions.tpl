<div class="actions blogpostactions pull-right btn-group"> {* changed from pull-right for this theme *}
	...
	<a class="btn btn-link" data-toggle="dropdown" href="#" style="padding-left: 0;">
