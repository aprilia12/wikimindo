{* $Id: blog_post_postbody_content.tpl 55106 2015-04-16 11:13:50Z walper $ *}
...
width: 21.42857143%; padding-bottom: 2em;">
					{include file='blog_post_author_info.tpl'}
				{*	{include file='blog_post_actions.tpl'} *}
				</div>
				<div class="entry-content" style="float: right; width: 71.42857144%;">
