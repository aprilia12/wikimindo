<?php /* Smarty version Smarty-3.1.21, created on 2018-08-07 05:22:46
         compiled from "C:\xampp\htdocs\tikiwiki\tiki-18.1\templates\layouts\classic\module.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8066922215b691086d6cf82-02764675%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b759c2927f988d173ce0830d062b73e60fcebb6e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tikiwiki\\tiki-18.1\\templates\\layouts\\classic\\module.tpl',
      1 => 1490205206,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8066922215b691086d6cf82-02764675',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b691086dc6d28_39121897',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b691086dc6d28_39121897')) {function content_5b691086dc6d28_39121897($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\tikiwiki\\tiki-18.1\\vendor_bundled\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.replace.php';
...
','module.png');">
								<?php echo smarty_function_icon(array('id'=>("icnmod-").(Smarty::$_smarty_vars['capture']['name']),'class'=>"flipmodimage",'name'=>"arrows-v",'alt'=>"[Toggle]"),$_smarty_tpl);?>
...
','vmodule.png');">
									<?php echo smarty_function_icon(array('id'=>("icnmod-").(Smarty::$_smarty_vars['capture']['name']),'class'=>"flipmodimage",'name'=>"move",'alt'=>"[Toggle Vertically]",'_defaultdir'=>"img"),$_smarty_tpl);?>
...
"
					...
					<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_layoutshadows']=='y') {
echo $_smarty_tpl->tpl_vars['prefs']->value['box_shadow_end'];?>
</div><?php }?>
				<?php } else { ?>
		</div>
	</div>
