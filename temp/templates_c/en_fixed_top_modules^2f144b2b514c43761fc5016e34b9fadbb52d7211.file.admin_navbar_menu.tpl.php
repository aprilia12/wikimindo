<?php /* Smarty version Smarty-3.1.21, created on 2018-08-07 05:21:26
         compiled from "C:\xampp\htdocs\tikiwiki\tiki-18.1\templates\admin\admin_navbar_menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14055441015b691036db99d5-95536555%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2f144b2b514c43761fc5016e34b9fadbb52d7211' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tikiwiki\\tiki-18.1\\templates\\admin\\admin_navbar_menu.tpl',
      1 => 1511371592,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14055441015b691036db99d5-95536555',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b691036e32b70_41021079',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b691036e32b70_41021079')) {function content_5b691036e32b70_41021079($_smarty_tpl) {?><?php if (!is_callable('smarty_function_service')) include 'C:/xampp/htdocs/tikiwiki/tiki-18.1/lib/smarty_tiki\\function.service.php';
?>
	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu">
			...
			<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_sefurl_routes']=="y"&&$_smarty_tpl->tpl_vars['tiki_p_admin']->value) {?>
				<li><a href="tiki-admin_routes.php">Custom Routes</a></li>
			<?php }?>
			...
			<?php if ($_smarty_tpl->tpl_vars['prefs']->value['sitemap_enable']=="y"&&$_smarty_tpl->tpl_vars['tiki_p_admin']->value) {?>
				<li><a href="tiki-admin_sitemap.php">Sitemap</a></li>
			<?php }?>
			<li class="divider"></li>
